...
description: 
published: true
date: 2023-05-06T02:22:55.266Z
tags: 中间件
editor: markdown
dateCreated: 2023-05-05T10:27:20.365Z
---
...
> 注意: 
>
> mysql 部署时需要将数据文件放进性能较好的存储设备里面, 否则会启动失败
>
> Mysql 通过helm 部署时,需要指定:
>
>   auth.rootPassword="xxx"
>
>   auth.username="test"
>
>   auth.password="test"
...
```yaml
[root@cmzhu mysql]# cat values.yaml
